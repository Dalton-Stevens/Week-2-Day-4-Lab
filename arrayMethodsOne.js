...
// CODE HERE
const taxedPrice = orders.map(element => +(element.price * (1 + element.tax)).toFixed(2));
...
// CODE HERE
const bobsTotal = purchases.filter(element => (element.owner.includes(`Bob`))).reduce((acc, curr) => acc + curr.price, 0);
